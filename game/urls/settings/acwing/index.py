...
urlpatterns = [
    path("web/apply_code/", web_ac, name="settings_web_apply_code"),
    path("web/receive_code/", web_rc, name="settings_web_receive_code"),
    path("acapp/apply_code/", acapp_ac, name="settings_acapp_apply_code"),
    path("acapp/receive_code/", acapp_rc, name="settings_acapp_receive_code"),
